    ...
    for _ in range(numTrials):
        ...
        for _ in range(numRolls):
            ...
            try:
                ...
                nums[number] = 1
        longestNumber = max(nums.values())
        diceLongestRuns.append( longestNumber )
    makeHistogram(diceLongestRuns, 10, 'longest runs', 'freq', 'longest runs')
    return sum(diceLongestRuns) / len(diceLongestRuns)
...
print(
    getAverage2(Die([1,2,3,4,5,6,6,6,7]), 50, 1000)
)